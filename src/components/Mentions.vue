    ...
    <div class="container">
      <div class="notification">
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>&nbsp;l'identité des différents intervenants dans le cadre
          de sa réalisation et de son suivi:
        </p>
        <p>
          <strong>Propriétaire</strong> : Hatem Satouri – Toulouse
          <br />

          <strong>Responsable publication</strong> : Hatem Satouri –
          hatem.satouri@yahoo.com
          <br />
          <strong>Webmaster</strong> : Hatem Satouri –
          hatem.satouri@yahoo.com
          <br />
        ...
        <p>
          ...
          <a href="https://wifitoulouse.fr">https://wifitoulouse.fr</a>&nbsp;implique l’acceptation pleine et entière des
          conditions générales d’utilisation ci-après décrites. Ces
          conditions d’utilisation sont susceptibles d’être modifiées
          ou complétées à tout moment, les utilisateurs du
          site&nbsp;
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>&nbsp;sont donc invités à les consulter de manière
          régulière.
        </p>
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>, qui s’efforcera alors de communiquer préalablement aux
          utilisateurs les dates et heures de l’intervention. Le site
          web&nbsp;
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>&nbsp;est mis à jour régulièrement par
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>
        ...
        <br />
        <h2 class="title is-4">3. Description des services fournis.</h2>

        <p>
          Le site internet&nbsp;
          <a href="https://wifitoulouse.fr">https://wifitoulouse.fr</a>&nbsp;a pour objet de fournir une information concernant
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>&nbsp;des informations aussi précises que possible.
          Toutefois, il ne pourra être tenu responsable des oublis,
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>&nbsp;sont données à titre indicatif, et sont susceptibles
          d’évoluer. Par ailleurs, les renseignements figurant sur le
          site&nbsp;
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>&nbsp;ne sont pas exhaustifs. Ils sont donnés sous réserve
          de modifications ayant été apportées depuis leur mise en
          ligne.
        </p>

        <br />
        <h2 class="title is-4">4. Limitations contractuelles sur les données techniques.</h2>
        ...
        <p>
          <a href="https://wifitoulouse.fr">https://wifitoulouse.fr</a>
        ...
        <br />
        <h2 class="title is-4">5. Propriété intellectuelle et contrefaçons.</h2>
        ...
        <br />
        <h2 class="title is-4">6. Limitations de responsabilité.</h2>
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>, et résultant soit de l’utilisation d’un matériel ne
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>. Des espaces interactifs (possibilité de poser des
        ...
        <br />
        <h2 class="title is-4">7. Gestion des données personnelles.</h2>
        ...
        <br />
        <h3 class="title is-6">7.1 Responsables de la collecte des données personnelles</h3>
        ...
        <p>
          ...
          Données Personnelles est : Hatem Satouri.
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>est représenté par Satouri, son représentant légal
        </p>
        ...
        <br />
        <h3 class="title is-6">7.2 Finalité des données collectées</h3>&nbsp;
        <p>
          <a href="https://wifitoulouse.fr">https://wifitoulouse.fr</a>
        ...
        <br />
        <h3 class="title is-6">7.3 Droit d’accès, de rectification et d’opposition</h3>&nbsp;
        <p>
        ...
        <br />
        <h3 class="title is-6">7.4 Non-communication des données personnelles</h3>
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>, celle-ci devra dans les meilleurs délais informer le
        ...
        <div ng-bind-html="rgpdHTML">
          <br />
          <h3 class="title is-6">7.5 Types de données collectées</h3>
        </div>

        <br />
        <h2 class="title is-4">8. Notification d’incident</h2>
        <p>
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>&nbsp;n'est publiée à l'insu de l'utilisateur, échangée,
        ...
        <br />
        <h3 class="title is-6">Sécurité</h3>
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>prend toutes les mesures raisonnables visant à les protéger
        ...
        <p>
          Le site&nbsp;
          <a href="https://wifitoulouse.fr">https://wifitoulouse.fr</a>&nbsp;contient un certain nombre de liens hypertextes vers
          d’autres sites, mis en place avec l’autorisation de
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>. Cependant,
          <a href="https://wifitoulouse.fr">https://wifitoulouse.fr</a>
        ...
        </p>Sauf si vous décidez de désactiver les cookies, vous acceptez
        ...
        <br />
        <h3 class="title is-6">9.1. « COOKIES »</h3>&nbsp;
        <p>
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>, résultant (i) du refus de Cookies par l’Utilisateur (ii)
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>, Twitter, Facebook, Linkedin et Google Plus peuvent
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>. À tout moment, l’Utilisateur peut néanmoins revenir sur
        ...
        <br />
        <h3 class="title is-6">Article 9.2. BALISES (“TAGS”) INTERNET</h3>&nbsp;
        <p>
          <a href="https://wifitoulouse.fr">https://wifitoulouse.fr</a>
        ...
        <p>
          ...
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>, et fournir d’autres services relatifs à l’utilisation de
          celui-ci et d’Internet.
        </p>&nbsp;
        <p></p>
        <br />
        <h2 class="title is-4">10. Droit applicable et attribution de juridiction.</h2>
        <p>
          Tout litige en relation avec l’utilisation du site&nbsp;
          <a
            href="https://wifitoulouse.fr"
          >https://wifitoulouse.fr</a>&nbsp;est soumis au droit français. En dehors des cas où la
          loi ne le permet pas, il est fait attribution exclusive de
          juridiction aux tribunaux compétents de Toulouse
        </p>
      </div>
      <br />
      <br />
